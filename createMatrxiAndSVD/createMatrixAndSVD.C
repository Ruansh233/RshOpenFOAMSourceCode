...
int main(int argc, char *argv[])
{
    ...
    fileName dataPath (mesh.time().path()/"109.5");

    fileName fieldName("Uz");
    ...
    forAll(mesh.cellZones()[0], cellI)
    {
        forAll(mesh.cellZones(), zoneI)
        {
            ...
            testM[cellI][zoneI] = Uz[cell];
        }
    }

    SVD uzField(testM);
    Info << "uzField.U().m()" << uzField.U().m() << endl
         << "uzField.U().n()" << uzField.U().n() << endl
         << "uzField.V().m()" << uzField.V().m() << endl
         << "uzField.V().n()" << uzField.V().n() << endl
         << "uzField.S().size()" << uzField.S().size() << endl;
