...
int main(int argc, char *argv[])
{
    ...
    // Rsh dictName is the default name in "setSystemMeshDictionaryIO.H"
    ...
    // Rsh, the location whether the patches are inputed
    PtrList<dictionary> patchSources(dict.lookup("patches"));

    // Rsh, patchSources contain the whole content of all dists
    Info << "patchSources " << patchSources << endl;

    // Rsh, insert the new patch name into the patch name list
    ...
    if (patchSources.size())
    {
        ...
        // Rsh
        // Info << "allPatches " << allPatches << endl;
        ...
        for (const dictionary& dict : patchSources)
        {
            ...
            // Rsh, patchName is the patch will be added into the new patch
    ...
    for (const dictionary& dict : patchSources)
    {
        ...
        if (sourceType == "patches")
        {
            ...
            Info << "dict.get<wordRes>patches " << dict.get<wordRes>("patches") << endl;
